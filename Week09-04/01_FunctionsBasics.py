...
# Clint MacDonald
# July 10, 2025
# Introduction to Modularity and Functions
# -----------------------------------
...
def sayHelloTo(name):#sub-routine
...
sayHelloTo(5)
name = "John"
sayHelloTo(name)  # the variable is sent in BY VALUE
print(name)

print('-'*40)

def sayHelloGreeting(greeting: str, name: str): #sub-routine
    '''A function to print out a greeting to the named object'''
...
def addAndSubtract( a: int, b: int):
    '''A function that returns both the sum and the difference of 2 numbers.'''
    add = a + b
    subtract = a - b
    return add, subtract
