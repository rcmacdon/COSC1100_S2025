...
def initialize_interface():
    ...
    # Title Label
    lblTitle = tk.Label(window, text="Calculator Application", font=("Arial Bold", 20), bg="lightgrey", border=2, relief="solid")
    ...
    btnSubtract = tk.Button(window, text="-", command=click_btnSubtract)
    btnSubtract.grid(row=2, column=1, sticky="WE")
    
    btnMultiply = tk.Button(window, text="x", command=click_btnMultiply)
    btnMultiply.grid(row=2, column=2, sticky="WE")
    
    btnDivide = tk.Button(window, text="/", command=click_btnDivide)
