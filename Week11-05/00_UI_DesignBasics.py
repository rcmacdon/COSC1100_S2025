...
# ----------------------------------------------------
'''
1. Font Choice - English as a second Language - easy to read
2. Tab Order - Keyboard Navigation - no mouse required
3. Tooltips - For Screen Readers and Visually Impaired
